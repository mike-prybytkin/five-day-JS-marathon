...
var returnToStartWindow = function returnToStartWindow() {
  var _a;
  (_a = document.querySelector('#new-game')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', function (e) {
    var _a;
    e.preventDefault();
    screens.forEach(function (el) {
      return el.classList.remove('up');
    });
    (_a = document.querySelector('.total-score')) === null || _a === void 0 ? void 0 : _a.remove();
  });
};
...
var createRandomCircle = function createRandomCircle() {
  var color1 = getRandomColor();
  var color2 = getRandomColor();
  var color3 = getRandomColor();
  var size = getRandomNumber(10, 60);
  var _a = board.getBoundingClientRect(),
    width = _a.width,
    height = _a.height;
